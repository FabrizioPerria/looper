...
public:
    ...
    void setOverdubGainNew (const double newGain) { volumeProcessor.setOverdubNewGain ((float) newGain); }
    void setOverdubGainOld (const double oldGain) { volumeProcessor.setOverdubOldGain ((float) oldGain); }
